...
create_project -part xcku060-ffva1517-1-i -force project-1ldpu-wrap
...
import_files -flat -force $dpu_src_dir/dpu_core.vhd
...
import_files -flat -force $src_dir/dpu_ctrl.vhd
import_files -flat -force $src_dir/dpu_ctrl_wrap.vhd
import_files -flat -force $src_dir/sim_memory.vhd
import_files -flat -force $src_dir/sim_dpu_ctrl.vhd

set_property used_in_synthesis false [get_files project-1ldpu-wrap.srcs/sources_1/imports/sim_dpu_ctrl.vhd]
set_property used_in_synthesis false [get_files project-1ldpu-wrap.srcs/sources_1/imports/sim_memory.vhd]

set_property top dpu_ctrl_wrap [current_fileset]
set_property top sim_dpu_ctrl [get_filesets sim_1]
...
set_property -dict [list CONFIG.NUM_SI {4} CONFIG.NUM_MI {1} CONFIG.ADDR_WIDTH {64} CONFIG.DATA_WIDTH {512} CONFIG.ID_WIDTH {6} CONFIG.M00_S03_READ_CONNECTIVITY {0} CONFIG.M00_S00_WRITE_CONNECTIVITY {0} CONFIG.M00_S01_WRITE_CONNECTIVITY {0} CONFIG.M00_S02_WRITE_CONNECTIVITY {0} CONFIG.S00_THREAD_ID_WIDTH {4} CONFIG.S01_THREAD_ID_WIDTH {4} CONFIG.S02_THREAD_ID_WIDTH {4} CONFIG.S03_THREAD_ID_WIDTH {4} CONFIG.S04_THREAD_ID_WIDTH {4} CONFIG.S05_THREAD_ID_WIDTH {4} CONFIG.S06_THREAD_ID_WIDTH {4} CONFIG.S07_THREAD_ID_WIDTH {4} CONFIG.S08_THREAD_ID_WIDTH {4} CONFIG.S09_THREAD_ID_WIDTH {4} CONFIG.S10_THREAD_ID_WIDTH {4} CONFIG.S11_THREAD_ID_WIDTH {4} CONFIG.S12_THREAD_ID_WIDTH {4} CONFIG.S13_THREAD_ID_WIDTH {4} CONFIG.S14_THREAD_ID_WIDTH {4} CONFIG.S15_THREAD_ID_WIDTH {4} CONFIG.S00_SINGLE_THREAD {1} CONFIG.S01_SINGLE_THREAD {1} CONFIG.S02_SINGLE_THREAD {1} CONFIG.S03_SINGLE_THREAD {1} CONFIG.S01_BASE_ID {0x00000010} CONFIG.S02_BASE_ID {0x00000020} CONFIG.S03_BASE_ID {0x00000030} CONFIG.S04_BASE_ID {0x00000040} CONFIG.S05_BASE_ID {0x00000050} CONFIG.S06_BASE_ID {0x00000060} CONFIG.S07_BASE_ID {0x00000070} CONFIG.S08_BASE_ID {0x00000080} CONFIG.S09_BASE_ID {0x00000090} CONFIG.S10_BASE_ID {0x000000a0} CONFIG.S11_BASE_ID {0x000000b0} CONFIG.S12_BASE_ID {0x000000c0} CONFIG.S13_BASE_ID {0x000000d0} CONFIG.S14_BASE_ID {0x000000e0} CONFIG.S15_BASE_ID {0x000000f0} CONFIG.M00_A00_ADDR_WIDTH {64}] [get_ips axi_crossbar_0]
