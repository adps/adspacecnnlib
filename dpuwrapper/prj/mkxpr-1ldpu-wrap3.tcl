...
create_project -part xcku060-ffva1517-1-i -force project-1ldpu-wrap3

set dpu_src_dir "../../onelayerdpu_tmr"
set src_dir ".."
...
import_files -flat -force $src_dir/sim_memory_wrs.vhd
import_files -flat -force $src_dir/sim_dpu_ctrl_wrs_tmr.vhd

set_property used_in_synthesis false [get_files project-1ldpu-wrap3.srcs/sources_1/imports/sim_dpu_ctrl_wrs_tmr.vhd]
set_property used_in_synthesis false [get_files project-1ldpu-wrap3.srcs/sources_1/imports/sim_memory_wrs.vhd]

set_property top dpu_ctrl_wrs_wrap_tmr [current_fileset]
set_property top sim_dpu_ctrl_wrs_tmr [get_filesets sim_1]
